<template>
    ...
    <el-drawer v-model="data.drawer" :title="data.isAdd ? '添加账户' : '修改账户'" direction="rtl" size="30%" :before-close="drawerClose">
        <div class="item">
            <el-upload class="avatar-uploader" 
                ...
                <img v-if="imageUrl" :src="admin_photo_base_url + imageUrl" class="avatar" />
